...
namespace mtgen.Services
{
    public class StorageContext : IStorageContext
    {
        ...
        public StorageContext(IOptions<ConnectionStrings> connectionStrings)
        {
            _connectionStrings = connectionStrings.Value;

            // Retrieve the storage account from the connection string.
            var cloudStorageAccount = CloudStorageAccount.Parse(_connectionStrings.mtgen_AzureStorageConnectionString);
        ...
        async public Task<DrawEntity> LoadDraw(string setCode, string drawId)
        {
            ...
            await SaveDraw(draw); // Not guaranteed to finish running.
